...
import { deleteGeminiKey, getAiEnvironment, saveGeminiKey, updateEnvFile } from "@/lib/envFile";
...
export async function POST(request: Request) {
  ...
  if (typeof body.deleteGeminiKeyId === "string") {
    deleteGeminiKey(body.deleteGeminiKeyId);
    return NextResponse.json({ ai: getAiEnvironment() });
  }
  ...
  if (typeof body.geminiKey === "string" && body.geminiKey.trim()) {
    saveGeminiKey(typeof body.geminiNickname === "string" ? body.geminiNickname : "", body.geminiKey.trim());
  }
